...
print_run_details <- function(out, fit, COUNTS_FILE, TAG, DIRECTORY, CVAL,
                              ...
                              GGPLOT, SINGLE_CHROM, SEED, RLIB_PATH, RLIB_VERSION, GIVE_PCVAL){
...
if(is.null(PURITY_CVAL)){
    ...
    facets_iteration(COUNTS_FILE, TAG, DIRECTORY, CVAL, DIPLOGR, NDEPTH, SNP_NBHD, MIN_NHET, GENOME, GGPLOT, SINGLE_CHROM, SEED, RLIB_PATH, RLIB_VERSION, GIVE_PCVAL=NULL)
}
